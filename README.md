...
The local development environment is configured automatically by the installation script.
...
The installation workflow performs:

- Prepare required database resources
- Download AdventureWorks2022 backup if it does not exist
- Start Microsoft SQL Server 2022 container
- Start PostgreSQL 17 container
- Restore AdventureWorks2022 database
- Initialize PostgreSQL Pagila database
- Create Python virtual environment (`.venv`)
- Install Python dependencies from `requirements.txt`
- Validate database service health and connectivity
...
The dashboard uses datasets generated by the Python ETL pipeline.
